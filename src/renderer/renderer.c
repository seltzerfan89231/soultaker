...
void load_textures(void)
{
    ...
    renderer.gui_textures[UPPER_A_TEX]      = texture_create("assets/textures/gui/text/A.png");
    renderer.gui_textures[UPPER_B_TEX]      = texture_create("assets/textures/gui/text/B.png");
    renderer.gui_textures[UPPER_C_TEX]      = texture_create("assets/textures/gui/text/C.png");
    renderer.gui_textures[UPPER_D_TEX]      = texture_create("assets/textures/gui/text/D.png");
    renderer.gui_textures[UPPER_E_TEX]      = texture_create("assets/textures/gui/text/E.png");
    renderer.gui_textures[UPPER_F_TEX]      = texture_create("assets/textures/gui/text/F.png");
    renderer.gui_textures[UPPER_G_TEX]      = texture_create("assets/textures/gui/text/G.png");
    renderer.gui_textures[UPPER_H_TEX]      = texture_create("assets/textures/gui/text/H.png");
    renderer.gui_textures[UPPER_I_TEX]      = texture_create("assets/textures/gui/text/I.png");
    renderer.gui_textures[UPPER_J_TEX]      = texture_create("assets/textures/gui/text/J.png");
    renderer.gui_textures[UPPER_K_TEX]      = texture_create("assets/textures/gui/text/K.png");
    renderer.gui_textures[UPPER_L_TEX]      = texture_create("assets/textures/gui/text/L.png");
    renderer.gui_textures[UPPER_M_TEX]      = texture_create("assets/textures/gui/text/M.png");
    renderer.gui_textures[UPPER_N_TEX]      = texture_create("assets/textures/gui/text/N.png");
    renderer.gui_textures[UPPER_O_TEX]      = texture_create("assets/textures/gui/text/O.png");
    renderer.gui_textures[UPPER_P_TEX]      = texture_create("assets/textures/gui/text/P.png");
    renderer.gui_textures[UPPER_Q_TEX]      = texture_create("assets/textures/gui/text/Q.png");
    renderer.gui_textures[UPPER_R_TEX]      = texture_create("assets/textures/gui/text/R.png");
    renderer.gui_textures[UPPER_S_TEX]      = texture_create("assets/textures/gui/text/S.png");
    renderer.gui_textures[UPPER_T_TEX]      = texture_create("assets/textures/gui/text/T.png");
    renderer.gui_textures[UPPER_U_TEX]      = texture_create("assets/textures/gui/text/U.png");
    renderer.gui_textures[UPPER_V_TEX]      = texture_create("assets/textures/gui/text/V.png");
    renderer.gui_textures[UPPER_W_TEX]      = texture_create("assets/textures/gui/text/W.png");
    renderer.gui_textures[UPPER_X_TEX]      = texture_create("assets/textures/gui/text/X.png");
    renderer.gui_textures[UPPER_Y_TEX]      = texture_create("assets/textures/gui/text/Y.png");
    renderer.gui_textures[UPPER_Z_TEX]      = texture_create("assets/textures/gui/text/Z.png");
