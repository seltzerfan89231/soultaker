...
{
    Component *blue_part = component_create(0, 0, 0, 14, COMP_DEFAULT, COLOR_TEX);
    blue_part->g = 0.0, blue_part->r = 0.0, blue_part->b = 1.0;
    Component *yellow_part = component_create(0, 0, 0, 14, COMP_DEFAULT, COLOR_TEX);
...
void comp_manabar_update(Component *comp)
{
    ...
    green_part->w = game_get_player_mana_ratio() * 100;
